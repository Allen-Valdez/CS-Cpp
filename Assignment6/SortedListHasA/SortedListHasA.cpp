...
// -------------------------------PREV GETPOSITION FOR STEP 1---------------------------------
// template <class ItemType>
// int SortedListHasA<ItemType>::getPosition(const ItemType &anEntry) const
// {
//    int position = 1;
//    int length = SortedListHasA<ItemType>::getLength();
//    while ((position <= length) && (anEntry > SortedListHasA<ItemType>::getEntry(position)))
//    {
//       position++;
//    }
//    if ((position < length) || (anEntry != SortedListHasA<ItemType>::getEntry(position)))
//    {
//       position = -position;
//    }
//    return position;
// }
// -------------------------------END GETPOSITION FOR STEP 1---------------------------------
